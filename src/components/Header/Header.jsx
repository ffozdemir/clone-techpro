...
export const Header = () => {
  return (
    <div>
      <Container fluid className="bg-primary p-3 text-white">
        <div className="d-flex justify-content-between align-items-center flex-wrap">
          ...
          <div className="d-flex align-items-center gap-3">
            <div className="d-flex align-items-center gap-2">
              <CircleFlag countryCode="tr" height="25" />
              <CircleFlag countryCode="de" height="25" />
              <IoPersonSharp style={{ color: "white", fontSize: "20px" }} />
            </div>

            <div className="d-flex align-items-center gap-2">
              <SocialIcons color="white" fontSize="20px" />
            </div>
          </div>
        </div>
      </Container>
